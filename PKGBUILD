...
_pkgverbase=2.30.5618.102
_upstreamdate=20241010
_wikidate=20241101
...
sha256sums=('6510cf464223d46042d446652a4f7e4bafc3be89ca5aa3990223d73a0df70089'
            ...
            '4537683e16570c2bd76eb0867454b3bfde26f1d98634d16f2021a3fdf843ef62')
...
prepare() {
    ...
    sed -i -e "s|jawiki-[a-z0-9]\{6,8\}|jawiki-${_wikidate}|g" count_word_hits.py apply_word_hits.py
...
build() {
    ...
    bazel build server:mozc_server gui/tool:mozc_tool renderer/qt:mozc_renderer unix/ibus:ibus_mozc unix/icons --config oss_linux --compilation_mode opt --copt='-Wno-maybe-uninitialized' --host_copt='-Wno-maybe-uninitialized'
}
