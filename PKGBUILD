...
provides=("mozc=${_pkgverbase}" "ibus-mozc=${_pkgverbase}" 'mozc-engine-module')
...
b2sums=(
    ...
    '437932fe575ef856a3f339b702d8841d5d5d2de94a1d1bc104e9d4d7a010fed7dbc7203c86affcc119f7ed4673b41e89ecbe570f5f6e5bd945fe21c2b47dc8e3'
...
prepare() {
    ...
    sed -i -e "s|mozc-master/src/data/dictionary_oss|${srcdir}/mozc/src/data/dictionary_oss|g ;
               ...
               104s|zip_ref\.|| ;
               169s|jawiki_index_file = .*|jawiki_index_file = '${srcdir}/jawiki-${_wikidate}-pages-articles-multistream-index.txt.bz2'| ;
...
build() {
    ...
    "${srcdir}"/bazel-9.0.2-linux-x86_64 build server:mozc_server gui/tool:mozc_tool renderer/qt:mozc_renderer unix/ibus:ibus_mozc \
